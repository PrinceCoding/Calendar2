...
function saveActiveCanvasState() {
  ...
  const widgets = [
    ...
    { el: document.getElementById('floatingCountdown'), id: 'floatingCountdown' },
...
function loadActiveCanvasState() {
  ...
  const defaultPositions = {
    ...
    floatingCountdown: { left: '700px', top: '100px' },
  ...
  const widgets = [
    ...
    { el: document.getElementById('floatingCountdown'), id: 'floatingCountdown', display: 'flex' },
  ...
  widgets.forEach(({ el, id, display }) => {
    ...
    const toggleMap = {
      ...
      'floatingCountdown': 'toggleCountdownApp',
